...
head_sha: 4797385b2670bbb965a37e6d7a7ee42d85053ba1
current_gate: C2
completed_gates: C0, C1
internal_testflight: NO-GO
public_v1: NO-GO
last_green_commands: node --test scripts/exclusionManifest.test.mjs scripts/reviewLookahead.test.mjs scripts/sourceWordCount.test.mjs (9 pass); node scripts/check_review_exclusions.mjs (4998 rows scanned, 0 exclusions, explicit zero-exposure snapshot). pgTAP not run: Docker engine is not running. Deno is not installed, so deletion_executor_test.ts was not executed. Jest is not installed in mobile/node_modules, so the mobile unit suite was not executed.
